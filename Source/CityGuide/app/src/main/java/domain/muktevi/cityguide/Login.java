...
public class Login extends AppCompatActivity {
    ...
    public void login(View view){
        ...
        String url = "https://api.mlab.com/api/1/databases/harishkolla/collections/users?q=%7B%22email%22%3A%22"+urlEncodedName+"%22%7D&apiKey=8fyxSo-jbRM_vhgz1T5cS13DNTco_dO0";
